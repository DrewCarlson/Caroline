...
public typealias EndpointDescriptionHook = OperationDsl.() -> Unit
public typealias PathDescriptionHook = PathDsl.() -> Unit
 ...
 */
public class TegralOpenApiKtor {
    /**
     * The context used by this plugin. This can be used to register new types.
     */
    public val context: SimpleDslContext = SimpleDslContext()
     ...
     */
    public inner class Configuration : RootDsl by builder

    /**
     * Ktor plugin object for [TegralOpenApiKtor].
     */
    public companion object Plugin : BaseApplicationPlugin<ApplicationCallPipeline, Configuration, TegralOpenApiKtor> {
        override val key: AttributeKey<TegralOpenApiKtor> = AttributeKey<TegralOpenApiKtor>("TegralOpenApiKtor")
     ...
     */
    public fun buildOpenApiDocument(): OpenAPI {
     ...
     */
    public fun registerOperation(path: String, method: HttpMethod, operation: OperationDsl.() -> Unit) {
        builder.apply {
     ...
     * You should use [describe] instead of this function.
     */
    public fun registerOperation(path: String, method: HttpMethod, operationBuilder: OperationBuilder) {
        builder.apply {
     ...
     */
    public fun withRootBuilder(description: RootDsl.() -> Unit) {
     ...
     */
    public fun registerSubrouteHook(route: Route, hook: OperationDsl.() -> Unit) {
     ...
     */
    public fun getHooksForRoute(route: Route): List<EndpointDescriptionHook> =
 ...
 */
public val Application.openApi: TegralOpenApiKtor get() = plugin(TegralOpenApiKtor)
