 ...
 * null.
 */
public fun Application.getOpenApiOrNullWithMessage(): TegralOpenApiKtor? {
 ...
 */
public fun Application.describe(description: RootDsl.() -> Unit) {
...
@TegralDsl
@KtorDsl
public infix fun Route.describe(description: OperationDsl.() -> Unit): Route {
 ...
 */
public typealias OperationBuilderWithHooks = (OpenApiDslContext, List<EndpointDescriptionHook>) -> OperationBuilder
 ...
 */
@TegralDsl
public infix fun Route.describeWith(builder: OperationBuilderWithHooks): Route {
