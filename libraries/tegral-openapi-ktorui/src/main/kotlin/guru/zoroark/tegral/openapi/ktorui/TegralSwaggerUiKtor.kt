 ...
 */
public class TegralSwaggerUiKtor(private val classpathPath: String) {
    /**
     ...
     */
    public companion object Plugin : BaseApplicationPlugin<ApplicationCallPipeline, Configuration, TegralSwaggerUiKtor> {
        override val key: AttributeKey<TegralSwaggerUiKtor> = AttributeKey<TegralSwaggerUiKtor>("KoaSwaggerUi")
 ...
 */
public fun Route.swaggerUiEndpoint(path: String, openApiPath: String) {
