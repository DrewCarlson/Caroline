 ...
 */
@TegralDsl
public interface PathDsl : OperationDsl {
    /**
     ...
     */
    public var get: OperationBuilder?
     ...
     */
    public var post: OperationBuilder?
     ...
     */
    public var put: OperationBuilder?
     ...
     */
    public var delete: OperationBuilder?
     ...
     */
    public var patch: OperationBuilder?
     ...
     */
    public var options: OperationBuilder?
     ...
     */
    public var head: OperationBuilder?

    /**
     * A definition of a GET operation on this path.
     */
    @TegralDsl
    public fun get(block: OperationDsl.() -> Unit)

    /**
     * A definition of a POST operation on this path.
     */
    @TegralDsl
    public fun post(block: OperationDsl.() -> Unit)

    /**
     * A definition of a PUT operation on this path.
     */
    @TegralDsl
    public fun put(block: OperationDsl.() -> Unit)

    /**
     * A definition of a DELETE operation on this path.
     */
    @TegralDsl
    public fun delete(block: OperationDsl.() -> Unit)

    /**
     * A definition of a PATCH operation on this path.
     */
    @TegralDsl
    public fun patch(block: OperationDsl.() -> Unit)

    /**
     * A definition of an OPTIONS operation on this path.
     */
    @TegralDsl
    public fun options(block: OperationDsl.() -> Unit)

    /**
     * A definition of a HEAD operation on this path.
     */
    @TegralDsl
    public fun head(block: OperationDsl.() -> Unit)
}
...
public class PathBuilder(private val context: OpenApiDslContext) : PathDsl, Buildable<PathItem> {
