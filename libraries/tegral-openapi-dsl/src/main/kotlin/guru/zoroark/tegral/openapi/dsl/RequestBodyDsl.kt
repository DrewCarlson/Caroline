 ...
 */
@TegralDsl
public interface RequestBodyDsl : BodyDsl {
    /**
 ...
 */
public class RequestBodyBuilder(context: OpenApiDslContext) : BodyBuilder(context), RequestBodyDsl, Buildable<RequestBody> {
