...
public interface SecurityDsl {
     ...
     */
    @TegralDsl
    public fun security(builder: SecurityRequirementsBuilder.() -> Unit)
}

/**
 * Builder for [SecurityRequirement]
 */
public class SecurityRequirementsBuilder : Buildable<SecurityRequirement> {
    private val securityRequirement = SecurityRequirement()

    /**
     * Adds a security requirement object with the given key.
     */
    public fun requirement(key: String) {
     ...
     */
    public fun requirement(key: String, vararg scopes: String) {
