 ...
 */
@TegralDsl
public interface BodyDsl : PredefinedContentTypesDsl {
    /**
     ...
     */
    @TegralDsl
    public val content: MutableList<Pair<String, Buildable<MediaType>>>
     ...
     */
    @TegralDsl
    public infix fun String.content(builder: MediaTypeBuilder.() -> Unit)
     ...
     */
    @TegralDsl
    public operator fun ContentType.invoke(builder: MediaTypeBuilder.() -> Unit) {
     ...
     */
    @TegralDsl
    public operator fun MultiContentType.invoke(builder: MediaTypeBuilder.() -> Unit) {
 ...
 */
@TegralDsl
public abstract class BodyBuilder(protected val context: OpenApiDslContext) : BodyDsl {
    override val content: MutableList<Pair<String, Buildable<MediaType>>> = mutableListOf()
