 ...
 */
@TegralDsl
public interface PredefinedContentTypesDsl {
    /**
     * [ContentType] object for `application/xml`
     */
    @TegralDsl
    public val xml: ContentType get() = ContentType("application/xml")

    /**
     * [ContentType] object for `application/json`
     */
    @TegralDsl
    public val json: ContentType get() = ContentType("application/json")

    /**
     * [ContentType] object for `application/x-www-form-urlencoded`
     */
    @TegralDsl
    public val form: ContentType get() = ContentType("application/x-www-form-urlencoded")

    /**
     * [ContentType] object for `text/plain`
     */
    @TegralDsl
    public val plainText: ContentType get() = ContentType("text/plain")
}
