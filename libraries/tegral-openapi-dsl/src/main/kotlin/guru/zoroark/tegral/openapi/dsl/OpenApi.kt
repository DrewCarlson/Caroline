 ...
 */
@TegralDsl
public fun openApi(builder: RootDsl.() -> Unit): OpenAPI {
 ...
 */
public fun OpenAPI.toJson(version: OpenApiVersion = OpenApiVersion.V3_0): String = when (version) {
 ...
 */
public fun OpenAPI.toYaml(version: OpenApiVersion = OpenApiVersion.V3_0): String = when (version) {
 ...
 * object**.
 */
public fun OpenAPI.toOpenApi31(): OpenAPI {
