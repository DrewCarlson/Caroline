 ...
 */
@TegralDsl
public interface RootDsl : InfoDsl, TagsDsl, PathsDsl, SecurityDsl {
    /**
     * Adds a security scheme to this OpenAPI document with the given string as the name, using the lambda to configure
     * further options.
     */
    @TegralDsl
    public infix fun String.securityScheme(scheme: SecuritySchemeDsl.() -> Unit)
     ...
     */
    @TegralDsl
    public infix fun String.server(server: ServerDsl.() -> Unit)
