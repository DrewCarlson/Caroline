 ...
 */
@TegralDsl
public interface ResponseDsl : BodyDsl {
    /**
     ...
     */
    public val headers: MutableList<Pair<String, Buildable<Header>>>

    /**
     * Add a header to this response with the given string as its name.
     */
    public infix fun String.header(builder: HeaderBuilder.() -> Unit)
}

/**
 * Builder for Response objects, implementing the [ResponseDsl].
 */
public class ResponseBuilder(context: OpenApiDslContext) : BodyBuilder(context), ResponseDsl, Buildable<ApiResponse> {
